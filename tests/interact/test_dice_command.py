...
async def test_rolling(
    parser, roller: DiceRollInteraction, payload: Context, guild: Guild
):
    ...
    public_channel: TextChannel = utils.get(
        guild.channels, name=config.team_options[guild.id].public_channel
    )
